  ...
  _texcoords(tex_coords)
{
	assert(vertices != nullptr &&
			"Параметр 'vertices' конструктора Model не может иметь значения nullptr!");
	assert(faces != nullptr &&
			"Параметр 'faces' конструктора Model не может иметь значения nullptr!");
	assert(normals != nullptr &&
			"Параметр 'normals' конструктора Model не может иметь значения nullptr!");
	assert(tex_coords != nullptr &&
			"Параметр 'tex_coords' конструктора Model не может иметь значения nullptr!");
